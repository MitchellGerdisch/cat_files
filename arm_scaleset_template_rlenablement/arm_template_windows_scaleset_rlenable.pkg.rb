...
# Basic Linux scaleset template with RightLink enablement 
# Key Features:
...
rs_ca_ver 20160622
short_description "Defines a Scaleset that includes a RL enablement custom script"

package "arm/windows/template"

# Build the message body with an in-line ARM template and applicable parameters.
define build_arm_template_launch_body($refresh_token, $uca_name, $servertemplate_href, $deployment_href, $param_instance_type, $param_os_version, $param_scaleset_name, $param_instance_count, $param_server_username, $param_server_password) return $arm_template_launch_body do
...
$arm_template = {
  ...
  "parameters": {
    ...
    "vmOSVersion": {
      ...
      "metadata": {
        "description": "The OS version for the VM. This will pick a fully patched image of this given Ubuntu version. Allowed values are: 15.10, 14.04.4-LTS."
      }
    },
    "vmssName":{
      "type":"string",
            ...
            "extensions": [
              {
                ...
                "properties": {
                  ...
                  "settings": {
                    "fileUris": [
                      "https://rightlink.rightscale.com/rll/10/rightlink.enable.ps1"
                      ],
                    "commandToExecute": "[concat('Powershell -ExecutionPolicy Unrestricted -File rightlink.enable.ps1 -l -RefreshToken \"', parameters('refresh_token'), '\" -ServerTemplateHref \"', parameters('servertemplate_href'), '\" -CloudName \"', parameters('uca_name'), '\" -DeploymentHref \"', parameters('deployment_href'), '\" -ServerName %ComputerName%')]"     
                  }
                }
              }
            ]
